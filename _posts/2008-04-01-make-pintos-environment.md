...
다음으로 pintos를 실행하기 위해 pintos를 다운로드 받았다. pintos는 구글 검색을 통해 다운로드 주소가 http://www.stanford.edu/class/cs140/projects/pintos/pintos.tar.gz에 있음을 찾아내서 wget 명령으로 다운로드 받았다.
